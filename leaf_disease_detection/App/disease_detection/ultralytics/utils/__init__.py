...
def yaml_save(file='apple_leaf02.yaml', data=None, header=''):
    """
    Save YAML data to a file.

    Args:
        file (str, optional): File name. Default is 'apple_leaf02.yaml'.
...
def yaml_load(file='apple_leaf02.yaml', append_filename=False):
    """
