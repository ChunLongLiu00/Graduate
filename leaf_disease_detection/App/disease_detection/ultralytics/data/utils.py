...
class HUBDatasetStats:
    ...
    Args:
        path (str): Path to apple_leaf02.yaml or data.zip (with apple_leaf02.yaml inside data.zip). Default is 'coco8.yaml'.
    ...
    def _unzip(path):
        """Unzip data.zip."""
        if not str(path).endswith('.zip'):  # path is apple_leaf02.yaml
